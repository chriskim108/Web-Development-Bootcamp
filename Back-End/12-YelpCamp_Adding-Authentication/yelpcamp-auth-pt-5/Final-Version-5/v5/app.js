...
//Whatever function we call it, it will be called onto every route
//It will be either empty if noone signed in or it will contain the user name and id
app.use(function(req,res,next){
    res.locals.currentUser = req.user; //This is the middleware
    next();
});
