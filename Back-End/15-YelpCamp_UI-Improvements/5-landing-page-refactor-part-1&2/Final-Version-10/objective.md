...
# Landing Page Refactor: Part Ones
* nodemon
    * Another version like "node app.js" but except we dont need to always restarting the server
    * How to install
        * npm install -g nodemon
* Calling nodemon
    * Just type in the terminal "nodemon"
    * Or we can state "nodemon app.js"
